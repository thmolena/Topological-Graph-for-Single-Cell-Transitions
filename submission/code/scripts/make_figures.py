...
def main() -> None:
    ...
    # The manuscript's "phase sweep" figure (fig_sweep.pdf) is the branching-
    # lineage scatter coloured by the control parameter with the H0-persistence
    # inset; write it under the name the manuscript \includegraphics-es.
    plotting.fig_lineage(summary, out / "fig_sweep.pdf")
    ...
    print(f"wrote {out}/fig_schematic.pdf, {out}/fig_sweep.pdf, "
