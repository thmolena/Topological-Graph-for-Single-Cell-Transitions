...
def test_barcode_has_n_minus_one_finite_bars():
    ...
    assert bc.n_bars == lin.n_cells - 1
...
def test_betti0_curve_monotone_nonincreasing_in_scale():
    ...
    # at scale 0 every cell is its own component; at a large scale it collapses.
    assert bc.betti0(-1.0) == lin.n_cells
